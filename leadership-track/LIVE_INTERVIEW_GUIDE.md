...
## Bloque 1 — Warm-up (10 min)

### Pregunta abierta
> *"Cuéntame de un equipo del que te sientas particularmente orgulloso. ¿Qué construyeron juntos, y cuál fue tu rol específico?"*

### Sigue con
- *"¿Qué cosa hizo ese equipo que tú no podrías haber logrado solo?"*
- *"¿Hubo alguien en ese equipo a quien hayas hecho crecer? Cuéntame."*

### Señales positivas
- Usa "nosotros" más que "yo".
- Nombra personas, no roles abstractos.
- Cita un fracaso o aprendizaje del equipo de forma natural.

### Red flags
- Habla solo de logros propios.
- Detalla métricas pero no menciona a nadie.
- Atribuye fracasos al equipo y éxitos a sí mismo.
...
- ✅ Separa el hecho (el bug) del comportamiento (minimizar en standup).
...
- ❌ Vergüenza implícita (*"todo el equipo te vio"*).
- ❌ Falsa empatía (*"sé cómo te sientes"* sin haber preguntado).
- ❌ Evita lo del standup y solo habla del bug técnico.
- ❌ Se enoja con tu acusación personal.
- ❌ Cierra sin compromiso ("hablamos otro día").
...
- **Razones reales (las soltarás si el candidato pregunta bien)**:
  1. Hace 8 meses no aprende algo nuevo.
  2. Sintió que el último ascenso pasó por delante de ella sin explicación.
...
- ✅ No promete nada en los primeros 60 segundos.
- ✅ Pregunta por motivación antes que por compensación.
- ✅ Reconoce el coraje de la conversación honesta.
- ✅ Es honesto sobre qué puede y qué no puede hacer (no "déjame ver", sí "esto sí puedo, esto no").
- ✅ Acepta la posibilidad de que se vaya sin presionar.

### Red flags
- ❌ Reacción defensiva (*"¿pero qué te pasó?"*).
...
- ✅ Pregunta el *porqué* del cambio antes de discutir el cómo.
- ✅ Separa la presión emocional del problema real.
- ✅ Propone alternativas concretas (scope, MVP, fases).
- ✅ Es transparente sobre trade-offs (*"podríamos llegar al 30 si quitamos X y aceptamos riesgo Y"*).
- ✅ Cuando lanzas la amenaza de escalación, no se intimida ni se enoja.

### Red flags
- ❌ Cede a la presión social ("ok, vemos qué se puede hacer").
- ❌ Se pone defensivo ("eso es problema del equipo, no mío").
- ❌ Promete sin consultar al equipo.
- ❌ Se enfrenta al PM en lugar de buscar solución conjunta.
- ❌ Usa el lenguaje técnico como escudo (*"no entiendes la complejidad"*).
- ❌ Acepta la amenaza ("ok, no escales, vemos cómo").
...
2. Léelo en voz alta o resume.
3. Pídele al candidato que **resuma su respuesta** en 60 segundos (no que la lea).
4. Lanza 2-3 contraescenarios extremos para ver si su criterio se sostiene.

### Ejemplo de presión por dilema

**Si elegiste Dilema 1 (raise injustificado)**:
- *"¿Y si su caída de performance es porque su madre está enferma y no te lo ha dicho?"*
- *"¿Y si tu CEO te dice que retener a este senior es prioridad estratégica esta semana?"*
- *"¿Y si descubres después que el aumento que diste se filtró al equipo y otros piden lo mismo?"*

**Si elegiste Dilema 7 (CTO con decisión mala)**:
- *"¿Y si el CTO está en la reunión y oye tu respuesta al equipo?"*
- *"¿Y si tu equipo te pide explícitamente que les digas que están en lo correcto?"*
- *"¿Y si tu equipo empieza a sabotear pasivamente la decisión del CTO usando tu silencio como respaldo?"*

### Señales positivas
- ✅ Sostiene su posición original cuando es coherente.
- ✅ Cambia de posición cuando aparece información nueva — y nombra explícitamente por qué cambia.
- ✅ Identifica los costos de su decisión.
- ✅ Distingue principios de tácticas.

### Red flags
- ❌ Cambia de posición al primer escenario duro sin razón clara.
- ❌ Defiende rígidamente sin reconocer matices.
- ❌ Responde con frases hechas de management ("hay que tener empatía").
- ❌ No identifica costo alguno de su camino.

---

## Bloque 6 — Q&A inversa (20 min)

### Lo que dices al candidato
> *"Te quedan 20 minutos para preguntar lo que quieras. Yo te respondo."*

### Qué evaluar (sin que el candidato lo sepa)
1. **¿Sobre qué pregunta primero?**
   - ✅ Por la gente: tamaño del equipo, perfiles, dinámicas.
   - ✅ Por la cultura: cómo se toman decisiones, cómo se da feedback.
   - ⚠️ Solo por compensación, beneficios, vacaciones.
   - ❌ Solo por el producto / stack técnico (esto es liderazgo, no IC).

2. **¿Qué profundidad tienen sus preguntas?**
   - ✅ Pregunta por situaciones concretas: *"¿Cómo manejaron el último incidente?", "¿quién es el dev más nuevo del equipo?", "¿qué pasó con la última persona que dejó el rol?".*
   - ❌ Preguntas genéricas: *"¿hay buen ambiente?", "¿cuál es la cultura?".*

3. **¿Pregunta por la persona a la que reportaría?**
   - ✅ Sí, con preguntas específicas sobre estilo.
   - ❌ No menciona a su futuro jefe.

4. **¿Pregunta por cómo medirías su éxito?**
   - ✅ Sí, y reta la respuesta si no es clara.
   - ❌ No, asume que es "hacer crecer el equipo".
...
- No dar feedback de la sesión en el momento.
- Indicar plazo de respuesta (recomendado: ≤ 5 días hábiles).
- Inmediatamente después de cerrar: el evaluador rellena la rúbrica EN CALIENTE (no posponer).
