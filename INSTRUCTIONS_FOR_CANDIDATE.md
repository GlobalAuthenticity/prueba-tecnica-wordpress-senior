...
Si te postulas a una posición con **responsabilidad sobre personas** (Tech Lead, Engineering Manager, Líder de Equipo de Desarrollo), debes completar también la capa de liderazgo en [`Evaluación de liderazgo/desafio-de-liderazgo.md`](Evaluación%20de%20liderazgo/desafio-de-liderazgo.md).
...
- Suma **~6-8 h asíncronas** + una **sesión en vivo de 60-90 min** con 3 simulaciones.
- Entregables separados en `entregables-liderazgo/` (no se mezclan con los técnicos).

Si tu rol es puramente IC, ignora la carpeta `Evaluación de liderazgo/`.
